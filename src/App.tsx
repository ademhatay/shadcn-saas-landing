...
const App = () => {
  ...
  const [starColor, setStarColor] = useState(theme.theme === "dark" ? "#fff" : "#FF7F00");

  useEffect(() => {
    setStarColor(theme.theme === "dark" ? "#fff" : "orange");
  }, [theme.theme]);
  ...
  return <>
    <Header />
    <div className="pt-32 h-screen w-screen hero relative">
      ...
      ></div>
      <h1 className="sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-3xl text-center font-medium bg-clip-text text-transparent  bg-gradient-to-r from-[#FF7F00] to-[#FFC0CB] py-6">
